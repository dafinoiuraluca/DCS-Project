...
public class Lane {
	public static void main(String[] args) {
		...
		// Add Pedestrian traffic light
		DataString ppl = new DataString();
		ppl.SetName("P_PL1");
		pn.PlaceList.add(ppl);
		...
		OP2.SetName("OP2");
		OP2.Value = new TransferOperation("localhost", "1081", "in1");
		...
		t2.InputPlaceName.add("P_PL1");

		Condition T2Ct1 = new Condition(t2, "P_TL1", TransitionCondition.Equal,"green");
		Condition T2Ct3 = new Condition(t2, "P_PL1", TransitionCondition.Equal,"red");
		...
		grdT2.Activations.add(new Activation(t2, "P_PL1", TransitionOperation.Move, "P_PL1"));

...
public class Lanes_Intersection {
	public static void main(String[] args) {
		...
		grdT22.Activations.add(new Activation(t3, "full", TransitionOperation.SendOverNetwork, "OP2"));
		grdT22.Activations.add(new Activation(t3, "P_a2", TransitionOperation.Copy, "P_a2"));
		t3.GuardMappingList.add(grdT22);
		...
		Condition T3Ct3 = new Condition(t5, "P_a3", TransitionCondition.NotNull);
		Condition T3Ct4 = new Condition(t5, "P_x3", TransitionCondition.CanNotAddCars);
		T3Ct3.SetNextCondition(LogicConnector.AND, T3Ct4);

		GuardMapping grdT33 = new GuardMapping();
		grdT33.condition= T3Ct3;
		grdT33.Activations.add(new Activation(t5, "full", TransitionOperation.SendOverNetwork, "OP3"));
		grdT33.Activations.add(new Activation(t5, "P_a3", TransitionOperation.Copy, "P_a3"));
		t5.GuardMappingList.add(grdT33);
		...
		Condition T4Ct3 = new Condition(t7, "P_a4", TransitionCondition.NotNull);
		Condition T4Ct4 = new Condition(t7, "P_x4", TransitionCondition.CanNotAddCars);
		T4Ct3.SetNextCondition(LogicConnector.AND, T4Ct4);

		GuardMapping grdT44 = new GuardMapping();
		grdT44.condition= T4Ct3;
		grdT44.Activations.add(new Activation(t7, "full", TransitionOperation.SendOverNetwork, "OP4"));
		grdT44.Activations.add(new Activation(t7, "P_a4", TransitionOperation.Copy, "P_a4"));
		t7.GuardMappingList.add(grdT44);
		...
		grdT3e.condition = T11Ct1;
		grdT3e.Activations.add(new Activation(t11, "P_o3", TransitionOperation.PopElementWithoutTarget, "P_o3Exit"));
		t11.GuardMappingList.add(grdT3e);
		...
		Condition T4gnCt1 = new Condition(t_g4n, "P_o4Exit", TransitionCondition.NotNull);

		GuardMapping grdT4gn = new GuardMapping();
		grdT4gn.condition = T4gnCt1;
		grdT4gn.Activations.add(new Activation(t_g4n, "P_o4Exit", TransitionOperation.SendOverNetwork, "P04N"));
		t_g4n.GuardMappingList.add(grdT4gn);
		t_g4n.Delay=0;

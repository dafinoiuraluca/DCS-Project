...
public class Controller {
    public static void main(String[] args) {
        ...
        op4.SetName("OP4");
        op4.Value = new TransferOperation("localhost", "1082" , "P_TL4");
...
//        pn.ConstantPlaceList.add(Five);
        ...
        grdT21.Activations.add(new Activation(t2, "Two", TransitionOperation.DynamicDelay,""));
        ...
        grdT4.Activations.add(new Activation(t4, "Two", TransitionOperation.DynamicDelay,""));
        ...
        grdT5.Activations.add(new Activation(t5, "green", TransitionOperation.SendOverNetwork, "OP1"));
        ...
        t6.InputPlaceName.add("in1");

        //for the first grd
        Condition T6Ct1 = new Condition(t6, "r1r2g3r4", TransitionCondition.NotNull);
        Condition T6Ct2 = new Condition(t6, "in1", TransitionCondition.IsNull);
        ...
        grdT6.Activations.add(new Activation(t6, "yellow", TransitionOperation.SendOverNetwork, "OP1"));
        grdT6.Activations.add(new Activation(t6, "yellow", TransitionOperation.SendOverNetwork, "OP3"));
        grdT6.Activations.add(new Activation(t6, "Two", TransitionOperation.DynamicDelay,""));
        ...
        grdT7.Activations.add(new Activation(t7, "red", TransitionOperation.SendOverNetwork, "OP1"));
        grdT7.Activations.add(new Activation(t7, "red", TransitionOperation.SendOverNetwork, "OP3"));
        grdT7.Activations.add(new Activation(t7, "green", TransitionOperation.SendOverNetwork, "OP2"));
        ...
        t8.InputPlaceName.add("in2");

        //for the first grd
        Condition T8Ct1 = new Condition(t8, "r1r2r3g4", TransitionCondition.NotNull);
        Condition T8Ct2 = new Condition(t8, "in2", TransitionCondition.IsNull);
        ...
        grdT8.Activations.add(new Activation(t8, "yellow", TransitionOperation.SendOverNetwork, "OP2"));
        grdT8.Activations.add(new Activation(t8, "yellow", TransitionOperation.SendOverNetwork, "OP4"));
        grdT8.Activations.add(new Activation(t8, "Two", TransitionOperation.DynamicDelay,""));
        ...
        grdT9.Activations.add(new Activation(t9, "red", TransitionOperation.SendOverNetwork, "OP2"));
